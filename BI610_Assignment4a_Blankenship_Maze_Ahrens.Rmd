...
The first subset contains 700 out of 1000 sampled academics whose papers show a lower impact in the field of humanities (lower h-index). In the second subset contains the remaining 300 data points with higher h-indexes (=higher impact).
...
```{rPhyChem - histogram h-index distribution}
